...
<script type="text/javascript" src="/ih-beta/themes/js/fancy-box/jquery-1.10.1.min.js"></script>

    <!-- Add mousewheel plugin (this is optional) -->
    <script type="text/javascript" src="/ih-beta/themes/js/fancy-box/jquery.mousewheel-3.0.6.pack.js"></script>
  
  <!--  // Add fancyBox main JS and CSS files -->
    <link rel="stylesheet" type="text/css" href="/ih-beta/themes/css/fancy-box/jquery.fancybox.css?v=2.1.5" media="screen" />
    <script type="text/javascript" src="/ih-beta/themes/css/fancy-box/jquery.fancybox.js?v=2.1.5"></script>
        ...
        <div role="tabpanel" class="tab-pane" id="settings">
                ...
                <?php
                        ...
                        foreach ($albums as $rows) {
                            ...
                            ?>
                        <a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo $path.$rows['name'];?>"><img src="<?php echo $path.$rows['name'];?>" alt="" style ="width: 23%; " /></a>
        ...
        <div class="container" id="#booknow">
            ...
            <table class="table table-striped table-bordered text-center">
                ...
                ?>
                        ...
                        <span class="bed_price"> <input type="checkbox" name="extra_bed_price"><?php if(!empty($currency)){
                                                foreach($currency as $cur){ 
                                                if($cur['currency_id']!="" && ($cur['currency_id'] == $rows['currency_id'])){
                                                    echo $cur['code']; 
                                                }
                                                }
                                                }?>&nbsp;<?php echo $rows['extra_bed_price'];?><span>
                    ...
                    <td><span class="price"><?php if(!empty($currency)){
                                                foreach($currency as $cur){ 
                                                if($cur['currency_id']!="" && ($cur['currency_id'] == $rows['currency_id'])){
                                                    echo $cur['code']; 
                                                }
                    ...
                    <span class=""><a href="#" class="masterTooltip" title="<?php if($rows['bookingfront'] == 'Y'){ echo $rows['bookingdescription']; }?>">Booking Condition</a></span>

                            <span class=""><a href="#" class="masterTooltip" title="<?php if($rows['freecancelfront'] == 'Y'){ echo $rows['freecancellation']; }?>">Free Cancellation</span>
                        </p></td>
                    <td>
                        ...
                        <input type="hidden" name="extra_bed_price" value="<?php echo $rows['extra_bed_price'];?>">
