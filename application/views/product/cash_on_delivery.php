...
<header class="page-header common-header bgc-dark-o-5">
  ...
  <div class="container text-center cell-vertical-wrapper">
    <div class="cell-middle">
      <h1 class="text-responsive size-l nmb"><?php echo ($this->crud->get_site_language() == 'ar') ? "الدفع عن الاستلام" : "Cash On Delivery" ?></h1>
    </div>
  </div>
</header>
<!--End Page Header-->
            ...
            <div class="container">
              ...
              <div class="row checkout-customer_detail pt-10">
                <div class="col-md-5 pb-10">
                    <div class="mb-10">
                     <h6 class="__title mb-35"><strong>CASH ON DELIVERY DETAIL *</strong></h6>
                      <div class="__inputs">
                      ...
                      <div class="__item"><span>
                        <input type="text" name="address" placeholder="Delivery Address *" required></span></div>
                      <div class="__message">
                        <textarea placeholder="Any Message" name="message"></textarea>
                        </div>
                      <div class="__item"><span>
                        <input type="hidden" name="payment_option" value="delivery" />
