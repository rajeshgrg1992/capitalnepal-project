...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            ...
            <a class="home" href="<?php echo site_url('products/products_detail/category_products/'.$product_category['category_slug']); ?>" title="Return to Category"><?php echo $product_category['category_title'];?></a>
            <span class="navigation-pipe">&nbsp;</span>
            <a class="navigation_page"><?php echo $product_sub_category['category_title'];?></a>
        </div>
        <!-- ./breadcrumb -->
        <!-- row -->
        <div class="row">
...
<?php 
                    ...
                    $category_banner_side = $this->crud->get_where("igc_advertisement",array('status'=>1,'delete_status'=>0,'ad_for'=>"sub_categories",'ad_sub_for'=>$product_sub_category['category_id'],'ad_placement'=>'banner','ad_sub_placement'=>'side_banner'));
                ...
                <!-- SPECIAL -->
        <?php 
            $sp_product=$this->crud->get_where_order_by_limit('products',array('delete_status'=>'0','status'=>1,'admin_status'=>1,'sp_product_status'=>'1','product_sub_cat_id'=>$product_sub_category['category_id']),"added_date","DESC",1);
        ...
        ?>
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                <!-- category-slider -->
                 <?php
                    $category_banner_top = $this->crud->get_where("igc_advertisement",array('status'=>1,'delete_status'=>0,'ad_for'=>"sub_categories",'ad_sub_for'=>$product_sub_category['category_id'],'ad_placement'=>'banner','ad_sub_placement'=>'top_banner'));
                    $ads_path="uploads/advertisement/"; 
                    ...
                    <ul>
                        <li>
                         ...
                         <?php
                            ...
                            {
                        ?>
                                <li <?php if($rows['category_id']==$product_sub_category['category_id']){echo "class=\"current-categorie\" ";}  else{echo "";} ?>><span></span
                                    >
                ...
                <div id="view-product-list" class="view-product-list">
                    <h2 class="page-heading">
                        <span class="page-heading-title"><?php echo $product_sub_category['category_title'];?></span>
                    </h2>
                    ...
                    <?php 
                        $folder_path="uploads/product/";
                        foreach($sub_cat_product_list as $key => $rows)
                        {
                    ?>
