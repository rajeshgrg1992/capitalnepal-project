...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            ...
            <a class="navigation_page"><?php echo $brands['brands_title'];?></a>
        </div>
        <!-- ./breadcrumb -->
        <!-- row -->
        <div class="row">
            ...
            <div class="column col-xs-12 col-sm-3" id="left_column">
               ...
               <!--  <div class="col-left-slide left-module">
                    <ul class="owl-carousel owl-style2" data-loop="true" data-nav = "false" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-items="1" data-autoplay="true">
                        <li><a href="#"><img src="eshopping/assets/data/slide-left.jpg" alt="slide-left"></a></li>
                        <li><a href="#"><img src="eshopping/assets/data/slide-left2.jpg" alt="slide-left"></a></li>
                ...
                <!--./left silde-->
                <?php 
            $sp_product=$this->crud->get_where_order_by_limit('products',array('delete_status'=>'0','status'=>1,'admin_status'=>1,'sp_product_status'=>'1','brands_id'=>$brands['brands_id']),"added_date","DESC",1);
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <div id="view-product-list" class="view-product-list">
                    <h2 class="page-heading">
                        <span class="page-heading-title"><?php echo $brands['brands_title']; ?></span>
                    </h2>
                    ...
                    <?php 
                        $folder_path="uploads/product/";
                        foreach($brands_products as $key => $rows)
                        {
                    ?>
