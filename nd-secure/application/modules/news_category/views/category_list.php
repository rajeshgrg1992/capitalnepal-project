                                    ...
                                    <div class="tab-pane fade active in" id="home">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                ...
                                                <a class="btn btn-info" data-rel="tooltip" href="<?php echo site_url('news_category/category');?>" title="Add Category"><i class="fa fa-plus-square-o"></i> Add Category</a>
                                            </div>
                                            <div class="panel-body">
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover"  id="dataTables-example">
                                                        ...
                                                        foreach($categories as $row)
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        <a href="<?php echo site_url('news_category/category/'. $row['category_id']);?>" class="btn btn-success" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
                                                                        <a href="<?php echo site_url('news_category/related_packages/'. $row['category_id']);?>" class="btn btn-primary" title="Related Product"><i class="fa fa-cogs"></i></a>
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            ...
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    ...
                                                                                    <h4 class="modal-title">Product Category Information Delete Confirmation</h4>
                                                                                </div>
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <input type="hidden" class="hidden_link_delete" value="<?php echo site_url('news_category/delete_category/'. $row['category_id']); ?>">
...
<script>
    $('.cat_active').click(function(){
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url() ?>index.php/news_category/show_front',
            dataType: "html",
