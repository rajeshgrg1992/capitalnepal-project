...
class Proservice extends MX_Controller{
    public function __Construct()
    {
        ...
        $this->load->model('proservice_model','content');
    ...
    public function index()
    {
        ...
        $data['title']= "Professional Service List";
        $this->load->view('header', $data);
        $this->load->view('proservice_list');
           ...
           // $insert['parent_id'] = $this->input->post('parent_id');
            ...
            if($insert['content_type'] == "Page" || "Services")
            {
                ...
                if($result)
                {
                    ...
                    $this->session->set_flashdata('success','New Professional Service has been inserted.');
                    redirect('proservice');
                }
                else{
                    $this->session->set_flashdata('error','Unable to insert the new Professional Service.');
                    redirect('proservice');
                }
            }
            else{
...
//                    exit;
        ...
        $this->load->view('header', $data);
        $this->load->view('proservice_form');
        $this->load->view('footer');
    }
