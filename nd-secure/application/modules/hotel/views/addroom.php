                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active in" id="home">
                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="name" id="name" size="50" value="" data-validation="required" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="roomsize" class="regular-text" size="50" value="" autocomplete="off" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                                 ...
                                 <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="views" class="regular-text" data-validation="required"  size="50" value="" autocomplete="off" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                                <?php
                                        ...
                                        <select name="room_id" class="room_id select-height">
                                            ...
                                            <?php
                                                foreach($room_type as $row)
                                                {
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $row['room_id'];?>" <?php echo (isset($room_type['room_name']) && $room_type['room_name'] == $row['id'])?"selected":"";?>><?php echo $row['room_name'];?></option>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="beds" class="regular-text" data-validation="required"  size="50" value="" autocomplete="off" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="slogan">Pax<span class="asterisk">*</span> </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="pax" class="regular-text" data-validation="required"  size="50" value="" autocomplete="off" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>

                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="slogan">Limited Room?</label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="checkbox" name="limitedroom" class="regular-text" value="Y"></td>
                                </tr>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="available_room" id="available_room" size="50" value="" data-validation="required" data-validation="number" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <?php
                                        $path  =  '../uploads/room/';
                                        if(isset($rooms['room_image']) && file_exists($path.$rooms['room_image']))

                                        {
                                            ...
                                            <div class="remove_option">
                                                ...
                                                ?>
                                                <img src="<?php echo $path.$rooms['room_image'];?>" alt="Room Image" style="max-width: 940px; max-height: 360px;">

                                                <span class="btn btn-info remove_btn" id="btn_remove">Remove</span>
                                            </div>
                                            <input type="hidden" name="pre_room_img" value="<?php echo $rooms['room_image']; ?>">
                                            <div id="image_input">
                                ...
                                <tr valign="top" class="contact_detail">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <textarea rows="5" cols="10" name="description" id="content_body"><?php echo (isset($content['description']) && $content['description'] !="") ? $content['description']:""; ?></textarea>
                                    </td>
                                </tr>
                        ...
                        <div class="tab-pane fade" id="price">
                            ...
                            <table class="form-table">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%; padding-left: 25px; padding-top: 15px;">
                                        <select name="currency_id" class="currency select-height">
                                            ...
                                            <?php
                                                ...
                                                {
                                                    ?>
                                                    <option value="<?php echo $row['currency_id'];?>" <?php echo (isset($content['currency_id']) && $content['currency_id'] == $row['id'])?"selected":"";?>><?php echo $row['cuurency_name'];?></option>
                                               <?php
                                                }
                                            ?>
                                           </select>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="price" id="price" size="50" value="" data-validation="required" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%; padding: 6px 0 0 0;">
                                        ...
                                        <input type="checkbox" name="isdiscount" class="regular-text"  value="Y">
                                    </td>
                                </tr>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="dprice" id="dprice" size="50" value=""  autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="tab-pane fade" id="children">
                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="extra_bed_price" id="extra_bed_price" size="50" value="" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                    </tr>
                                    <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="infant">Infant<span class="asterisk">*</span>
                                        </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="infant" id="infant" size="50" value="" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"> 
                                    <input type="text" name="infantdesc" id="infantdescription" size="50" style="height:80px;" value="" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="children">Children<span class="asterisk">*</span>
                                        </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="child" id="child" size="50" value="" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"> 
                                    <input type="text" name="childdesc" id="childdesc" size="50" style="height:80px;" value="" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label>Description </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <textarea name="extrabeds" id="tab-body" rows="5" cols="100"><?php echo (isset($content['extrabeds']) && $content['extrabeds'] !="") ? $content['extrabeds']:""; ?></textarea><br>
                        ...
                        <div class="tab-pane fade" id="meta">
                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="bookingcondition" id="bookingcondition" size="50" value="" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                    </tr>
                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="bookingdescription">Description </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <textarea name="bookingdescription" id="bookingdescription" rows="5" cols="80"><?php echo (isset($content['meta_description']) && $content['meta_description'] !="") ? $content['meta_description']:""; ?></textarea><br>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="checkbox" name="bookingfront" class="regular-text" value="Y"> Show Front? </td>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <textarea name="freecancellation" rows="5" cols="80"><?php echo (isset($content['meta_keywords']) && $content['meta_keywords'] !="") ? $content['meta_keywords']:""; ?></textarea><br>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="checkbox" name="freecancelfront" class="regular-text" value="Y"> Show Front? </td>
                        ...
                        <div class="tab-pane fade" id="features">
                            ...
                            <table class="form-table">
                                ...
                                ?>
                                <input type="checkbox" name="featureid[]" value="<?php echo $feature_id; ?>" /><?php echo $feature_name; ?>    
                                <ul style="margin-left:30px">
                                <?php
                                ...
                                ?>
                                <li>
                                <input type="checkbox" name="featureid[]" value="<?php echo $child_id; ?>" /><?php echo $key['features_name']; ?></br>
                                  <?php
                                }
                                }
                                ?>
                    ...
                    if(! empty($records))
                    {
                        foreach($records as $row)
                        {
                            ...
                            <div class="col-md-3 gal-image">
                                ...
                                ?>
                                <input type="checkbox" name="room_album[]"  value="<?php echo $album_id;?>">
