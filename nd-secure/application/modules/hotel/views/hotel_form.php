                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active in" id="home">
                            ...
                            <table class="form-table">
                                <tbody>
                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="hote_name">Hotel Name<span class="asterisk">*</span>
                                        </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="name" id="name" size="50" value="<?php echo (isset($hotel['name']) && $hotel['name'] !="") ? $hotel['name']:""; ?>" data-validation="required" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="code" class="regular-text" data-validation="required"  size="50" value="<?php echo (isset($hotel['code']) && $hotel['code'] !="") ? $hotel['code']:""; ?>" autocomplete="off" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                        ...
                        <div class="tab-pane fade" id="location">
                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="city" id="city" size="50" value="<?php echo (isset($hotel['city']) && $hotel['city'] !="") ? $hotel['city']:""; ?>" data-validation="required" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>

                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="admin_name">Latitude<span class="asterisk">*</span>
                                        </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="latitude" id="latitude" size="50" value="<?php echo (isset($hotel['latitude']) && $hotel['latitude'] !="") ? $hotel['latitude']:""; ?>" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>

                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="admin_name">Longitude<span class="asterisk">*</span>
                                        </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="longitude" id="longitude" size="50" value="<?php echo (isset($hotel['longitude']) && $hotel['longitude'] !="") ? $hotel['longitude']:""; ?>" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                        ...
                        <div class="tab-pane fade" id="price">
                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="startingprice" id="startingprice" size="50" value="<?php echo (isset($hotel['startingprice']) && $hotel['startingprice'] !="") ? $hotel['startingprice']:""; ?>" data-validation="required" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="tab-pane fade" id="meal">
                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="lunch_price" id="lunch_price" size="50" value="" data-validation="required" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                    </tr>
                                    <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="dinner_price" id="dinner_price" size="50" value="" data-validation="required" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <p class="submit">
                            <input type="hidden" name="id" id="id" value="<?php echo (isset($content['id']) && $content['id'] !="") ? $content['id']:""; ?>">
