...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            <form  method="post"  action="<?php echo base_url(); ?>index.php/news/add_news" accept-charset="UTF-8" enctype="multipart/form-data">
            <div class="col-sm-9">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <option value="<?php echo $r['reporter_id']; ?>"><?php echo $r['reporter_title'] ?></option>
                                <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control " name="guest_id" tabindex="-1" aria-hidden="true">
                                         <option value="">None</option>
                                         <?php foreach ($get_active_guest as $guest) { ?>
                                    <option value="<?php echo $guest['guest_id']; ?>"><?php echo $guest['guest_title'] ?></option>
                                <?php } ?>
                                    </select>
                                </div>
                        ...
                        <div class="box-body">
                            <label for="title"> <i class="fa fa-youtube-play"></i> <b>Youtube Code Only</b></label>
                       
                             <input type="text" placeholder="Enter Code here" class="form-control" name="video" id="video" value="">
                        </div>
...
?>
                            ...
                            <input type="datetime-local" placeholder="Date" class="form-control" name="published_at" id="published_at" value="<?php echo $now->format('Y-m-d H:i:s');?>">
                                                ...
                                                <div class="modal-dialog modal-xl">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title">HASTAKALA SANCHAR MEDIA GALLERY</h4>
                                                        </div>
