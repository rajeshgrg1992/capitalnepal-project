          ...
          <div class="box">
            ...
            <div class="panel-body">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#home" data-toggle="tab">Question and Answer</a>
                    </li>
                        ...
                        <div class="tab-pane fade active in" id="home">
                            ...
                            <table class="form-table content-adjustment">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                     <select name="content_type" class="page_type form-control">
                                        ...
                                        <option value="QA"  <?php echo (isset($content['content_type']) && $content['content_type'] =="QA")?"selected":"";?>>Question and Answer</option>
                                ...
                                <tr valign="top">
                                    ...
                                    <th style="background: transparent none repeat scroll 0% 0%; padding-top: 10px;" scope="row"><label>Published<span class="asterisk">*</span> </label></th>
                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                   <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="about_service">Link Page </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <select class="form-control" name="about_service_link" class="form-control">
                ...
                ?>
                                ...
                                <tr valign="top">
                                   <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="about_service">Link Page </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <select name="about_choose_link" class="form-control" class="form-control">
                                            <option value=""> Select </option>
                                            <?php
