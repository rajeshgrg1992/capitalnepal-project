...
class Content extends MX_Controller{
    ...
    public function form($id=0)
    {
        ...
        if($this->input->post())
        {
            ...
            $this->form_validation->set_rules('content_title_ar', 'content_title_ar' );
            ...
            $this->form_validation->set_rules('content_page_title_ar', 'content_page_title' );
            $this->form_validation->set_rules('content_body', 'content_body');
            $this->form_validation->set_rules('content_body_ar', 'content_body_ar');
            $this->form_validation->set_rules('content_type', 'content_type');
            $this->form_validation->set_rules('meta_description', 'meta_description');
            $this->form_validation->set_rules('meta_description_ar', 'meta_description_ar');
            $this->form_validation->set_rules('meta_keywords', 'meta_keywords');
            $this->form_validation->set_rules('meta_keyword_ar', 'meta_keyword_ar');
            $this->form_validation->set_rules('meta_title', 'meta_title');
            $this->form_validation->set_rules('meta_title_ar', 'meta_title_ar');

            $this->form_validation->set_rules('about_service', 'about_service');
            $this->form_validation->set_rules('about_service_ar', 'about_service_ar');
            $this->form_validation->set_rules('about_service_desc', 'about_service_desc');
            $this->form_validation->set_rules('about_service_desc_ar', 'about_service_desc_ar');
            ...
            $this->form_validation->set_rules('about_choose_ar', 'about_choose_ar');
            $this->form_validation->set_rules('about_choose_desc', 'about_choose_desc');
            $this->form_validation->set_rules('about_choose_desc_ar', 'about_choose_desc_ar');
            ...
            $this->form_validation->set_rules('about_support_ar', 'about_support_ar');
            $this->form_validation->set_rules('about_support_desc', 'about_support_desc');
            $this->form_validation->set_rules('about_support_desc_ar', 'about_support_desc_ar');
            ...
            $insert['content_title_ar'] = $this->input->post('content_title_ar') ;
            $insert['content_page_title'] = $this->input->post('content_page_title');
            $insert['content_page_title_ar'] = $this->input->post('content_page_title_ar');
            $insert['content_body'] = $this->input->post('content_body');
            $insert['content_body_ar'] = $this->input->post('content_body_ar');
            $insert['meta_description'] = $this->input->post('meta_description');
            $insert['meta_description_ar'] = $this->input->post('meta_description_ar');
            $insert['meta_keywords'] = $this->input->post('meta_keywords');
            $insert['meta_keyword_ar'] = $this->input->post('meta_keyword_ar');
            $insert['meta_title'] = $this->input->post('meta_title');
            $insert['meta_title_ar'] = $this->input->post('meta_title_ar');

            $insert['about_service'] = $this->input->post('about_service');
            $insert['about_service_ar'] = $this->input->post('about_service_ar');
            $insert['about_service_desc'] = $this->input->post('about_service_desc');
                $insert['about_service_desc_ar'] = $this->input->post('about_service_desc_ar');
             $insert['about_service_link'] = $this->input->post('about_service_link');
             
            $insert['about_choose'] = $this->input->post('about_choose');
                $insert['about_choose_ar'] = $this->input->post('about_choose_ar');
            $insert['about_choose_desc'] = $this->input->post('about_choose_desc');
                $insert['about_choose_desc_ar'] = $this->input->post('about_choose_desc_ar');
             $insert['about_choose_link'] = $this->input->post('about_choose_link');
             
            $insert['about_support'] = $this->input->post('about_support');
                $insert['about_support_ar'] = $this->input->post('about_support_ar');
            $insert['about_support_desc'] = $this->input->post('about_support_desc');
                $insert['about_support_desc_ar'] = $this->input->post('about_support_desc_ar');
            ...
            $insert['delete_status'] = "0";
                $insert['content_url'] = strtolower(preg_replace('/[^A-Za-z0-9\-\']/', '-', $insert['content_page_title']));
            //$insert['content_url'] = strtolower(str_replace(" ","-",$insert['content_title']));
