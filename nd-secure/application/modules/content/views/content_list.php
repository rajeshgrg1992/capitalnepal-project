            ...
            <div class="box-body">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <i class="fa fa-plus-square-o"></i><a href="<?php echo site_url('content/form');?>"> Add New Content</a>
                    </div>
                        ...
                        foreach($records as $row)
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        <a class="btn btn-success btn-xs" href="<?php echo site_url('content/form/'. $row['content_id']);?>"  title="Edit"><i class="fa fa-pencil-square-o"></i></a>
