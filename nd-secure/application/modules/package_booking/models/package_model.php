...
class Package_model extends  CI_Model
{
    ...
    {
        $query = $this->db->query("select * From igc_package_booking where delete_status = '0' order by booking_id desc ");
        $result = $query->result_array();
        return $result;
    }
    ...
    {
        $query = $this->db->query("select * FROM igc_package_booking where booking_id = '$booking_id' ");
        $result = $query->row_array();
        return $result;
    }
