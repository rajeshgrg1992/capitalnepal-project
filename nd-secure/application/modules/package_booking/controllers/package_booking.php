...
class Package_booking extends MX_Controller
{
    ...
    public  $table = "igc_package_booking";
    public $field_name = "booking_id";
    public  $redirect = "package_booking";
    ...
    public function delete($id)
    {
        ...
        if($result)
        {
            ...
            $log['action_id']= "3";
            $this->create_log($log);
            $this->session->set_flashdata('success','Query has been deleted.');
            redirect($this->redirect);
        }
        else{
            $this->session->set_flashdata('error','Unable to delete the Query.');
            redirect($this->redirect);
        }
...
<div style="width:580px;margin:0 auto;font:12px Arial,Helvetica,sans-serif;background:#fff">
    ...
    <table width="100%" cellspacing="0" cellpadding="5" border="0">
        <tr>
            <td style="border-bottom:1px solid #eee">Reference Number</td>
            <td style="border-bottom:1px solid #eee"> '.$session['reference_no'].'</td>
        </tr>
        <tbody>
        <tr>
        ...
        <tr>
            ...
            <td style="border-bottom:1px solid #eee">'. $session['package_name'] .'</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="border-bottom:1px solid #eee">'. $session['package_duration'] .'</td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="border-bottom:1px solid #eee">Passenger</td>
        ...
        <tr>
            ...
            <td style="border-bottom:1px solid #eee"> '.$session['amount']." ". $session['code'].'</td>
            </tr>
             <tr>
            <td style="border-bottom:1px solid #eee">'.$type_heading.'</td>
            <td style="border-bottom:1px solid #eee"> '.$session['edited_amount']." ". $session['code'].'</td>
            </tr>
            <tr>
             <td style="border-bottom:1px solid #eee">Total Amount</td>
            <td style="border-bottom:1px solid #eee"> '.$session['total_amount']." ". $session['code'].'</td>
        </tr>
        <tr>
            <th style="background:#eee" colspan="2">Note</th>
        </tr>
         <tr>
            <td colspan = "4" style="border-bottom:1px solid #eee">Your Booking information has been changed. If you have any queries Please contact us. </td>
        </tr>
   ...
   <div style="margin:0 0 10px"> <img alt="Incentive Holidays" src="'.$site_settings['site_url'].'themes/images/logos/navbar-logo.png"> </div>
    ...
    <table width="100%" cellspacing="0" cellpadding="5" border="0">
        ...
        <tbody>
          <tr>
            <td style="border-bottom:1px solid #eee">Reference Number:</td>
            <td style="border-bottom:1px solid #eee"> '.$data['reference_no'].'</td>
        </tr>
        <tr>
           <p>'.$data['message'].'</p>
        </tr>
