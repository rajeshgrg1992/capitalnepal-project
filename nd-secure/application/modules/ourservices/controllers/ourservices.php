...
class Ourservices extends MX_Controller{
    public function __Construct()
    {
        ...
        $this->load->model('ourservices_model','content');
    ...
    public function index()
    {
        ...
        $data['title']= "Our Services List";
        $this->load->view('header', $data);
        $this->load->view('ourservices_list');
...
//                    exit;
        ...
        $data['title']= "Add/Edit Our Services";
        $this->load->view('header', $data);
        $this->load->view('ourservices_form');
        $this->load->view('footer');
    }
