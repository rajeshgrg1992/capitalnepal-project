                        ...
                        <div class="tab-pane fade active in" id="home">
                            ...
                            <table class="form-table content-adjustment">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" class="form-control" name="full_name"  size="50" data-validation="required" value="<?php echo (isset($setting['full_name']) && $setting['full_name'] !="") ? $setting['full_name']:""; ?>"  autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>

                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="slogan">Host<span class="asterisk">*</span> </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="email" class="form-control" name="email" data-validation="required" class="regular-text"   size="50" value="<?php echo (isset($setting['email']) && $setting['email'] !="") ? $setting['email']:""; ?>" autocomplete="off" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
