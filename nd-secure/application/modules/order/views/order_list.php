                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover" id="example1">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>Products counts in Stock</th>
                                                    <th>Sold Status</th>
                                                    <th>Control</th>
                                                </tr>
                                                </thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                         <span>
                                                            <?php echo $product_detail['counts'] ; ?><br>
                                                         </span>
                                                       
                                                            <?php if($product_detail['counts'] == 0)
                                                            {
                                                            ?>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-<?php echo ($order_record['sold_status'] ==1)?"success":"danger"; ?> btn-sm" 
                                                            href="<?php echo site_url('order/check_action/'.$order_record['id'].'/'.$order_record['sold_status'].'/'.$order_record['quantity']);?>" 
                                                            title="<?php echo ($order_record['sold_status'] ==1)?"click if unsold":"click if sold"; ?>">
                                                            <i class="fa fa-<?php echo ($order_record['sold_status'] ==1)?"check":"remove"; ?> "></i>
                                                        </a>
                                                    </td>
                                                    <td>
                                                         <a class="btn btn-info btn-sm" data-target="#myModal_info<?php echo $order_record['id'];?>" data-toggle="modal" title="Info"><i class="fa fa-info-circle "></i></a>
                                            <?php
                                                    if($this->session->userdata('permission')=='0')
                                                    {
                                            ?>
                                                        <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModel_<?php echo $row['id']; ?>"><i class="fa fa-trash"></i></a>
                                            <?php
                                                    }
                                            ?>
                                                      ...
                                                      <!-- --------- Delete Modal Area ------------------ -->
                                                        <div id="deleteModel_<?php echo $row['id']; ?>" class="modal fade" role="dialog">
                                                          <div class="modal-dialog">
                                                            <!-- Modal content-->
                                                            <div class="modal-content">
                                                            <form method="POST" action="<?php echo site_url('order/delete/'.$row['id']); ?>">
                                                              <div class="modal-header">
