    ...
    <section class="content">
                                            ...
                                            <table class="form-table content-adjustment">
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <input type="text" class="form-control" name="reporter_title" data-validation-allowing="float"
                                                               size="50" data-validation="required"
                                                               value="<?php echo (isset($detail['reporter_title']) && $detail['reporter_title'] != "") ? $detail['reporter_title'] : ""; ?>"
       ...
       <tr valign="top">
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <input type="text" class="form-control" name="reporter_caption" data-validation-allowing="float"
                                                               size="50" data-validation="required"
                                                               value="<?php echo (isset($detail['reporter_caption']) && $detail['reporter_caption'] != "") ? $detail['reporter_caption'] : ""; ?>"
                                                               autocomplete="off" class="regular-text required valid"
                                                               kl_virtual_keyboard_secure_input="on"></td>
                                                </tr>
                                                ...
                                                <tr valign="top" id="featured_img">
                                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label><br />Reporter Image</label></th>
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <?php
                                                        $path  =  '../uploads/reporter/';
                                                        if(isset($detail['reporter_image']) && file_exists($path.$detail['reporter_image']))
                                                        {
                                                            ...
                                                            <div class="remove_option">
                                                                ...
                                                                <img src="<?php echo $path. $detail['reporter_image'];?>"  style="max-width: 940px; max-height: 360px;">

                                                                <span class="btn btn-info remove_btn" id="btn_remove">Remove</span>
                                                            </div>
                                                            <input type="hidden" class="form-control" name="pre_reporter_image" value="<?php echo $detail['reporter_image']; ?>">
                                                            <div id="image_input">
                                                                <input type="file" class="form-control" name="reporter_image" id="reporter_image">(Image Dimension 800*454 px)
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            <input type="file" class="form-control" name="reporter_image"  id="reporter_image">
                                                            <p id="sig_error1" style="display:none; color:#FF0000;">Image formats should be JPG, JPEG, PNG or GIF.</p>
              ...
              <tr valign="top">
                  ...
                  <tr valign="top">
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <textarea class="form-control" name="reporter_description" data-validation="required" id="reporterdescription" ><?php echo (isset($detail['reporter_description']) && $detail['reporter_description'] != "") ? $detail['reporter_description'] : ""; ?></textarea>
                                        ...
                                        <p class="submit">
                                            <input type="hidden" name="reporter_id"
                                                   value="<?php echo (isset($detail['reporter_id']) && $detail['reporter_id'] != "") ? $detail['reporter_id'] : ""; ?>">
                                            <input type="submit" name="Setting Btn" id="reporter_btn" class="button" value="Save">
                                        </p>
...
<script>
    CKEDITOR.replace( 'reporterdescription'  ,{
...
<script>
    ...
    $('#reporter_btn').click(function(e)
    {

        var a=0;

        var ext1 =  $('#reporter_image').val().split('.').pop().toLowerCase();
