                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label>Clients Title <span class="asterisk">*</span></label>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            if(isset($detail['clients_image']) && file_exists($path.$detail['clients_image']))
                                                            {
                                                                ...
                                                                <div class="remove_option">
                                                                    ...
                                                                    <img src="<?php echo $path. $detail['clients_image'];?>"  style="width: 20%">

                                                                    <span class="btn btn-info remove_btn" id="btn_remove">Remove</span>
                                                                </div>
                                                                <input type="hidden" class="form-control" name="pre_clients_image" value="<?php echo $detail['clients_image']; ?>">
                                                                <div id="image_input">
                                                                    <input type="file" class="form-control" name="clients_image" id="clients_image">(Image Dimension 237*273 px)
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                <input type="file" class="form-control" name="clients_image"  id="clients_image">
                                                                <p id="sig_error1" style="display:none; color:#FF0000;">Image formats should be JPG, JPEG, PNG or GIF.</p>
