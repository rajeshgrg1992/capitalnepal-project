                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover" id="example1">
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                            <a title="Click To Uncheck" href="<?php echo site_url('product/unchecked_product_list/'.$productId); ?>" class="btn btn-success btn-xs">
                                                    ...
                                                    <?php
                                                        ...
                                                        {
                                                    ?>
                                                            <a title="Click To Check" href="<?php echo site_url('product/checked_product_list/'.$productId); ?>" class="btn btn-danger btn-xs">
