                                            ...
                                            <table class="form-table content-adjustment">
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <input type="text" name="portfolio_title" class="form-control" data-validation-allowing="float"
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <input type="text" name="portfolio_caption" class="form-control" data-validation-allowing="float"
                                                               size="50" data-validation="required"
