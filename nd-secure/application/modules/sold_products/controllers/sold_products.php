...
class Sold_products extends CI_Controller
{
	...
	{
        $data['records'] = $this->crud->get_where_desc1("igc_sell_store",array('delete_status'=>0,'admin_ref'=>""));
		$data['title']="Seller Sold Products";

        $this->load->view('header', $data);
        $this->load->view('sold_products_list');
 ...
 //            }      
 //        }
 //        $data['products']=$this->crud->get_where("products",array('delete_status'=>"0","admin_ref >"=>0));
