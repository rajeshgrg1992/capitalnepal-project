                                            ...
                                            <table class="form-table content-adjustment">
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <input type="text" name="name" class="form-control" data-validation="required"  size="50" data-validation="text required" value="<?php echo (isset($detail['name']) && $detail['name'] !="") ? $detail['name']:""; ?>"  autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on">
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <input type="text" name="title" data-validation="required" class="form-control"  size="50" data-validation="text required" value="<?php echo (isset($detail['title']) && $detail['title'] !="") ? $detail['title']:""; ?>"  autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on">
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <textarea name="description" class="form-control" id="news" style="height: 450px !important;"><?php echo (isset($detail['description']) && $detail['description'] !="") ? $detail['description']:""; ?></textarea>
                                                    </td>
                                                </tr>
