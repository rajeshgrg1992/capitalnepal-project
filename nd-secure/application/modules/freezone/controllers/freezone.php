...
class Freezone extends MX_Controller{
    public function __Construct()
    {
        ...
        $this->load->model('freezone_model','content');
    ...
    public function index()
    {
        ...
        $data['title']= "Freezone List";
        $this->load->view('header', $data);
        $this->load->view('freezone_list');
