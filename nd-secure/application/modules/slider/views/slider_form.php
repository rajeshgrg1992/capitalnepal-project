                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="Slider">  Slider Title <span class="asterisk">*</span>   </label>
                                                            <input type="text" name="slider_title" class="form-control" data-validation-allowing="float"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="slider_caption" class="form-control" data-validation-allowing="float"
                                                                   size="50" data-validation="required"
                                                                   value="<?php echo (isset($detail['slider_caption']) && $detail['slider_caption'] != "") ? $detail['slider_caption'] : ""; ?>"
                                                                   autocomplete="off" class="regular-text required valid"
                                                                   kl_virtual_keyboard_secure_input="on">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="slider_link" value="<?php echo (isset($detail['slider_link']) && $detail['slider_link'] != "") ? $detail['slider_link'] : ""; ?>" >
