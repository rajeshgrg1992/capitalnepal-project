                                    ...
                                    <div class="tab-content">
                                            ...
                                            <table class="form-table content-adjustment">
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <input type="text" class="form-control" name="team_title" data-validation-allowing="float"
                                                               size="50" data-validation="required"
                                                               value="<?php echo (isset($detail['team_title']) && $detail['team_title'] != "") ? $detail['team_title'] : ""; ?>"
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <input type="text" class="form-control" name="team_caption" data-validation-allowing="float"
                                                               size="50" data-validation="required"
                                                               value="<?php echo (isset($detail['team_caption']) && $detail['team_caption'] != "") ? $detail['team_caption'] : ""; ?>"
                                                               autocomplete="off" class="regular-text required valid"
                                                               kl_virtual_keyboard_secure_input="on"></td>
                                                </tr>
                                                ...
                                                <tr valign="top" id="featured_img">
                                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label><br />Team Image</label></th>
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <?php
                                                        $path  =  '../uploads/team/';
                                                        if(isset($detail['team_image']) && file_exists($path.$detail['team_image']))
                                                        {
                                                            ...
                                                            <div class="remove_option">
                                                                ...
                                                                <img src="<?php echo $path. $detail['team_image'];?>"  style="max-width: 940px; max-height: 360px;">

                                                                <span class="btn btn-info remove_btn" id="btn_remove">Remove</span>
                                                            </div>
                                                            <input type="hidden" class="form-control" name="pre_team_image" value="<?php echo $detail['team_image']; ?>">
                                                            <div id="image_input">
                                                                <input type="file" class="form-control" name="team_image" id="team_image">(Image Dimension 800*454 px)
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <textarea class="form-control" name="team_description" data-validation="required" id="teamdescription" ><?php echo (isset($detail['team_description']) && $detail['team_description'] != "") ? $detail['team_description'] : ""; ?></textarea>
                                        ...
                                        <p class="submit">
                                            <input type="hidden" name="team_id"
                                                   value="<?php echo (isset($detail['team_id']) && $detail['team_id'] != "") ? $detail['team_id'] : ""; ?>">
                                            <input type="submit" name="Setting Btn" id="team_btn" class="button" value="Save">
                                        </p>
...
<script>
    ...
    $('#team_btn').click(function(e)
    {
        ...
        var ext1 =  $('#team_image').val().split('.').pop().toLowerCase();
