                ...
                <div class="tab-content">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <a class="btn btn-info" data-rel="tooltip" href="<?php echo site_url('package_category/sub_category_form');?>" title="Add Product Sub Category"><i class="fa fa-plus-square-o"></i> Add Product Sub-Category</a>
                            </div>
                            <div class="panel-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="<?php echo site_url('package_category/related_packages/'. $rows['sub_category_id']);?>" class="btn btn-primary" title="Related Product"><i class="fa fa-cogs"></i></a>
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <h4 class="modal-title">Product Sub-Category Information Delete Confirmation</h4>
                                                                </div>
