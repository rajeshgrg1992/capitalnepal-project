                                    ...
                                    <div class="tab-pane fade active in" id="home">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                ...
                                                <a class="btn btn-info" data-rel="tooltip" href="<?php echo site_url('package_category/category');?>" title="Add Product Category"><i class="fa fa-plus-square-o"></i> Add Product Category</a>
                                            </div>
                                            <div class="panel-body">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <a href="<?php echo site_url('package_category/related_packages/'. $row['category_id']);?>" class="btn btn-primary" title="Related Product"><i class="fa fa-cogs"></i></a>
