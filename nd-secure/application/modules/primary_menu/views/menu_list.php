                    ...
                    <div class="box-body">
                        <div class="page-content">
                            ...
                            <a style="float:right;margin-top:-5px;margin-right:5px;" class="btn btn-primary" href="<?php echo site_url('al/edit_group/'.$group['id']); ?>"><i class="icon-edit icon-white"></i> Edit</a> -->
                                                <!--                             <a style="float:right;margin-top:-5px;margin-right:5px;" class="btn btn-success" href="--><?php ////echo site_url('primary_menu/add/'.$group['id']); ?><!--"><i class="icon-plus icon-white"></i> Add item to group</a>-->
                                            </div>
                                            <div class="info_box">
                                                <ol class="sortable">
