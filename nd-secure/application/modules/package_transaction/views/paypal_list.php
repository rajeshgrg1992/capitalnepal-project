...
foreach($paypal as $row)
{
   ...
   <td><?php echo $row['transaction_id'];?></td>
    <td><?php echo $row['payment_amount']." ". $row['code'];?></td>
   
    <td><?php echo $row['book_from'];?></td>
    <td><?php echo $row['pay_status'];?></td>
    <td class="center">
        <div class="btn-group">
            <a class="btn btn-info" data-target="#modalNew<?php echo $row['transaction_id'];?>" data-toggle="modal" title="Detail"><i class="fa fa-info-circle" ></i></a>
           <!--  <a class="btn btn-warning" data-target="#myModal_cancel<?php echo $row['transacion_id'];?>" data-toggle="modal" title="Cancel"><i class="fa fa-ban"></i></a> -->
    ...
    <div class="modal fade" id="modalNew<?php echo $row['transaction_id'];?>">
