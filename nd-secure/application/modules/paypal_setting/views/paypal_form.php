                        ...
                        <table class="form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="api_username" data-validation="required" class="regular-text" style=" width:336px;">      
                                    </td>
                                </tr>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="api_password" data-validation="required" class="regular-text" style=" width:336px;">
                                    </td>   
                                </tr>
                                <tr valign="top">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="api_signature" data-validation="required" class="regular-text" style=" width:336px;">
                                    </td>   
                                </tr>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <select name ="paypal_mode" class="paypal_mode" style="margin: 7%; width: 93%; height: 53%;">
                                            <option name="live">live</option>
                                            <option name="sandbox">sandbox</option>
                                        </select>
