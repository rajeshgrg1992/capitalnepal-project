...
class News extends MX_Controller{
        ...
        if($this->input->post())
        {
            ...
            if($news_id =="")
            {
                ...
                if($result)
                {
                    ...
                    $this->session->set_flashdata('error','Unable to add Job');
                    redirect($this->redirect);
                }
                ...
                if($result)
                {
                    ...
                    $this->session->set_flashdata('error','Unable to update the Job.');
                    redirect($this->redirect);
                }
    ...
    public function delete($id)
    {
        ...
        if($result)
        {
            ...
            $this->session->set_flashdata('success','Job has been deleted.');
            redirect($this->redirect);
        }
        else{
            $this->session->set_flashdata('error','Unable to delete the Job.');
            redirect($this->redirect);
        }
