                                        ...
                                        <div class="tab-pane fade active in" id="home">
                                            ...
                                            <table class="form-table content-adjustment">
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" class="form-control" name="content_title" id="content_title" size="50" value="<?php echo (isset($content['content_title']) && $content['content_title'] !="") ? $content['content_title']:""; ?>" data-validation="required" autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                                </tr>
                                                ...
                                                <tr valign="top" id="featured_img">
                                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row">
                                                        <label><br />Featured Image: </label></th>
                                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                                        <?php
...
<script>
    ...
    CKEDITOR.replace( 'tab-body2'  ,{
        ...
        filebrowserBrowseUrl : '/charteredtax/filemanager/dialog.php?type=2&editor=ckeditor&fldr=',
        filebrowserUploadUrl : '/charteredtax/filemanager/dialog.php?type=2&editor=ckeditor&fldr=',
        filebrowserImageBrowseUrl : '/charteredtax/dubaisetup/filemanager/dialog.php?type=1&editor=ckeditor&fldr='
