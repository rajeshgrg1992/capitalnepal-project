                ...
                <form class="tab_form" method="post" action="" enctype="multipart/form-data">
                            ...
                            <table class="form-table">
                                ...
                                <div class="col-md-6">  <div class="form-group">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="features_name" data-validation="required" class="regular-text">
                    ...
                    <tr valign="top">
                        ...
                        <p style="width:50%; float:left">
                            <input type="text" name="cname[]" class="regular-text" /><i class="fa fa-trash-o" aria-hidden="true"></i> </p>
                            <p style="width:50%; float:left">          
                            <input type="text" name="cname[]" class="regular-text" /><a class="delete-features " title="remove"><i class="fa fa-trash-o" aria-hidden="true"></i></a></p>
                    </td>
                    </div></div>
                </tr>
                </tbody>
