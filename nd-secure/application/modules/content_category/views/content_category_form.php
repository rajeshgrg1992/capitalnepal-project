                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active in" id="home">
                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label>Category Name
                                             <span class="asterisk">*</span>
                                        </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="category_name" data-validation-allowing="float"
                                               size="50" data-validation="required"
                                               value="<?php echo (isset($detail['category_name']) && $detail['category_name'] != "") ? $detail['category_name'] : ""; ?>"
