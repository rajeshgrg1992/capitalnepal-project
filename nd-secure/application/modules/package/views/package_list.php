                    ...
                    <div class="box-body">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                ...
                                <a class="btn btn-info" data-rel="tooltip" href="<?php echo site_url('package/form');?>" title="Add Product"><i class="fa fa-plus-square-o"></i> Add New Product</a>
                            </div>
                                        ...
                                        foreach($records as $row)
                                        {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    ...
                                                    <input type="radio"  <?php echo isset($row['show_front']) && $row['show_front'] == "1" ? "checked":""?> id="<?php echo $row['package_id'];?>" class="pkg_active"> IN STOCK
                                                    <input type="radio" <?php echo isset($row['show_front']) && $row['show_front'] == "0" ? "checked":""?> id="<?php echo $row['package_id'];?>" class="pkg_inactive"> OUT STOCK
                                                </td>
                                                <td class="center">
                                                    <div class="btn-group">
