  ...
  <div class="login-box-body">
    ...
    <form method="post" action="">
      <div class="form-group has-feedback">
        <input type="text" name="username" class="form-control" required value="<?php echo set_value('username');?>" placeholder="Username" >
	  ...
	  <div class="form-group has-feedback">
        <input type="password" name="passconf" value="" id="retype" class="form-control" placeholder="Confirm Password" required>
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="row">
        <div class="col-xs-8">
