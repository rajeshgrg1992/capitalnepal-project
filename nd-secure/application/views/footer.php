<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="http://nectardigit.com">Nectar Digit Pvt. Ltd.</a>.</strong> All rights
    reserved.
  </footer>
...
if(current_url() !== site_url().'/'.'category_sorting'){

    echo '<script src="theme/bower_components/jquery/dist/jquery.min.js"></script></script>';
}
